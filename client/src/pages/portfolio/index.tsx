...
export default function Portfolio() {
  ...
  return (
    <>
      <Helmet>
        <title>Portfolio | Totrakool Khongsap</title>
        <meta name="description" content="Portfolio showcasing AI and data science expertise - Totrakool Khongsap" />
      </Helmet>
      
      <main className="flex min-h-screen flex-col items-center justify-between bg-modern-background">
        <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-12">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-8">Portfolio & Expertise</h1>
          <p className="text-lg text-center text-modern-mutedForeground mb-12 max-w-3xl mx-auto">
            A showcase of my experience and capabilities in AI, data science, and technical leadership.
          </p>
        </div>
